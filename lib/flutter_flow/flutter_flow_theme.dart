...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF404140);
  late Color tertiary = const Color(0xFF7F7F7F);
  late Color alternate = const Color(0xFFBEBEBD);
  late Color primaryText = const Color(0xFF313131);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFFF2F4FA);
  ...
  late Color titleText = Color(0xCCFFFFFF);
}
